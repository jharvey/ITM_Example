...
ifeq ($(USE_OPT),)
  USE_OPT = -O0 -g3 -ggdb -lm -fomit-frame-pointer -falign-functions=16
endif
...
INCDIR = $(CONFDIR) $(ALLINC) $(TESTINC) $(CHIBIOS)/os/hal/include \
    $(CHIBIOS)/os/hal/lib/streams  $(CHIBIOS)/os/various/shell
